	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main" >			
		...
		<div class="row" >
			...
			<div class="form-group">
									...
									<div class="form-group col-md-2">
								<button type="button" onClick="location.href='AddnewLoryReceipt.php'"class="btn btn-primary">New LR</button>
								<br>
								</div>	
					...
					<div class="form-group">
									...
									<div class="col-md-2">
									<input  required type="number" id="rate1"  name="ad"  type="number" placeholder="100"  class="form-control">
									</div>
					...
					<div class="form-group col-lg-12">
									...
									<div class="col-md-2">
									<input  id="stax" disabled="true"  name="stax"  value="0" type="number"   class="form-control">
									</div>
									
									<label class="col-md-1 control-label" for="name">Edu. Cess</label>
									<div class="col-md-2">
									<input  id="etax" disabled="true"  value="0" name="etax"  type="number"   class="form-control">
									</div>
									
									<label class="col-md-1 control-label" for="name">Hsc Cess </label>
									<div class="col-md-2">
									<input  id="htax" disabled="true"  value="0" name="htax"  type="number"   class="form-control">
									</div>
									
									<label class="col-md-1 control-label" for="name">Total Srv Tax</label>
									<div class="col-md-2">
									<input  id="ttax" disabled="true" value="0" name="ttax"  type="number" onfocus="totaltax();"  class="form-control">
									</div>
...
function clearall1(){
	...
	document.getElementById("detention").value=0;
